...
const Products = () => {
  ...
  const addNewProduct = async () => {
    try {
      await axios.post("https://cafemanager-2ji8.onrender.com/api/products/add", newProduct);
      fetchProducts();
  ...
  const handleCheckout = async () => {
    ...
    try {
      await axios.post("https://cafemanager-2ji8.onrender.com/api/cart/add", purchaseData);
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete("https://cafemanager-2ji8.onrender.com/api/products/delete", {
